...
routes.post("/user/delete", UserController.auth, UserController.delete);

routes.put("/user", UserController.auth, upload.single("picture"), UserController.update);
...
routes.put("/group/:id", UserController.auth, GroupController.update);
...
routes.put("/contact/:id", UserController.auth, ContactController.update);
